var pck = {
    ...
    refurbish: function () {
            ...
            buyhtml += "<tr><td><span class='font-buy'>买" + 10 + "</span></td><td>" + 11 + "</td><td>" +123 + "</td></tr>";
            sellhtml = "<tr><td><span class='font-sell'>卖" + 20 + "</span></td><td>" + 21 + "</td><td>" + 123 + "</td></tr>" + sellhtml;
            ...
            if(true){
        		html += "<span class='font-buy'>买</span>";
            }
            else 
            {
                html += "<span class='font-sell'>卖</span>";
            }
            
            html += "</td><td>" + 10 + "</td><td>" + 123 + "</td>";
            html += "<td><span class='mui-btn mui-btn-xs mui-btn-danger' onclick='pck.cancel(" + 1 + ", " + 1 + ")'>撤单</a></td></tr>";
            content += html;
